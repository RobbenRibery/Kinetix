...
from kinetix.environment.ued.editor_o3_mini_8inner_v1 import (
    mmp_cluster_shapes,
...
def make_mutate_env_with_mmp(static_env_params: StaticEnvParams, params: EnvParams, ued_params: UEDParams):
